    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-column">
          ...
          <p className="footer-note">Get updates and discounts weekly!</p>
        </div>
      </div>

      <div className="footer-bottom">
        <p>© 2025 MyStore — <a href="https://twitter.com/mahnoor" target="_blank">@mahnoor</a></p>
      </div>
    </footer>
  );
};
